                        ...
                        "parts": [
                            {
                                "text": (
                                    ...
                                    "'skills_required' (comma-separated list of specific technical skills, programming languages, frameworks, libraries, tools, and databases. Exclude broad fields of study, degrees, departments, or soft skills like 'Computer Science', 'Data Science', 'Artificial Intelligence', 'Software Engineering', 'Communication', 'Management', etc. Focus only on specific technical competencies like Python, React, SQL, AWS, Git, etc.), "
